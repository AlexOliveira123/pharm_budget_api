...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i3.IDatabaseConnection>(
      () => _i4.DatabaseConnection(get<_i5.DatabaseConnectionConfig>()));
  gh.lazySingleton<_i6.IUserRepository>(() => _i7.UserRepository(
      connection: get<_i3.IDatabaseConnection>(), logger: get<_i8.ILogger>()));
  gh.lazySingleton<_i9.IUserService>(
      () => _i10.UserService(get<_i6.IUserRepository>()));
  gh.factory<_i11.AuthController>(() => _i11.AuthController(
      userService: get<_i9.IUserService>(), logger: get<_i8.ILogger>()));
  return get;
}
