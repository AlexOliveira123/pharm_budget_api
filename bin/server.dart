...
import 'package:pharm_budget_api/application/middlewares/default_content_type/default_content_type_middleware.dart';
...
void main(List<String> args) async {
  ...
  final handler = Pipeline()
      ...
      .addMiddleware(DefaultContentTypeMiddleware().handler)
